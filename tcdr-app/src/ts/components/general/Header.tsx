          ...
          <div className="flex flex-wrap items-center gap-2">
            <ThemeToggle />
               <button
                type="button"
                className={[
                  "btn btn-sm btn-primary shadow-sm shadow-primary/20 transition-all relative select-none",
                  "btn-disabled cursor-not-allowed opacity-60 pointer-events-none", // force non-interactive
                ].join(" ")}
                title="Not implemented yet"
                aria-label="Run all tests (coming soon)"
                aria-disabled="true"
                disabled
              >
              {isRunning ? (
